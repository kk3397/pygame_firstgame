...
class enemy(object):
    ...
    def draw(self, window):
        ...
        if self.visible:
            ...
            pygame.draw.rect(window, (0, 128, 0),(self.hitbox[0], self.hitbox[1] - 20, 50 - (5 * (10 - self.health)), 10))  # NEW
...
while run:
    # set fps to 27
    clock.tick(27)
    if man.hitbox[1] < goblin.hitbox[1] + goblin.hitbox[3] and man.hitbox[1]+man.hitbox[3] > goblin.hitbox[1]:  # Checks x coords
